odoo.define('odoo_app_project_permission.add_contact_line', function (require) {
    "use strict";
        ...
        init: function (parent, state, params) {
            ...
            try {
                if (state['model'] == 'res.partner') {
                    if (parent['model'] && (parent['model'] == 'project.add.follower' || parent['model'] == 'project.remove.follower')) {
